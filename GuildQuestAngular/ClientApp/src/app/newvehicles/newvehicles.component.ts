...
@Component( {
  ...
  templateUrl: './newvehicles.component.html',
  styleUrls: ['./newvehicles.component.scss'],
  providers: []
} )
...
export class NewvehiclesComponent implements OnInit
{
  ...
  getUsedVehicles()
  {
    this.featService.getNewVehicles().subscribe(
      data =>
      {
      ...
      () => console.log( 'done loading new vehicles' )
    );
  }
